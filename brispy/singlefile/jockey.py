...
class SingleFileJockey(Jockey):
    def __init__(self, name: str, apprentice_weight_allowed: int, starts: int, wins: int, places: int, shows: int,
                 ...
                 previous_year_shows: int, previous_year_roi: float, at_distance_on_turf_label: str,
                 at_distance_on_turf_starts: int, at_distance_on_turf_wins: int, at_distance_on_turf_places: int,
                 at_distance_on_turf_shows: int, at_distance_on_turf_roi: float, at_distance_on_turf_earnings: int):
        super().__init__()
        self.name: str = name
        ...
        self.at_distance_on_turf_label: str = at_distance_on_turf_label
        self.at_distance_on_turf_starts: int = at_distance_on_turf_starts
        self.at_distance_on_turf_wins: int = at_distance_on_turf_wins
        self.at_distance_on_turf_places: int = at_distance_on_turf_places
        self.at_distance_on_turf_shows: int = at_distance_on_turf_shows
        self.at_distance_on_turf_roi: float = at_distance_on_turf_roi
        self.at_distance_on_turf_earnings: int = at_distance_on_turf_earnings
